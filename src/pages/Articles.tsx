...
const Articles = () => {
  ...
  const refChange = useRef<HTMLTextAreaElement>(null);
    ...
    <main>
      ...
      <section>
        ...
        <section
          ...
          <textarea
            ref={ref}
            style={{ width: '95%', height: '100px', margin: '4px' }}
            name="article_text"></textarea>
          <br />
            ...
            <article key={`article_${article.id}`} className="topic">
              {changeArticleId === article.id ? (
                <>
                  ...
                  <textarea
                    ...
                    defaultValue={article.text}></textarea>
                </>
              ) : (
                <>
                  <div
              ...
              <footer style={{ marginTop: '16px' }}>
                <FontAwesomeIcon
                  ...
                  icon={faXmark}
                  color="red"
                  onClick={() => handleOnDeleteArticle(article.id)}
                />
                {changeArticleId === article.id ? (
                  <FontAwesomeIcon
                  ...
                  <FontAwesomeIcon
                    style={{ cursor: 'pointer' }}
                    icon={faEdit}
                    onClick={() => setChangeArticleId(article.id)}
                  />
                )}
                {changeArticleId !== article.id && (
                  <FontAwesomeIcon
